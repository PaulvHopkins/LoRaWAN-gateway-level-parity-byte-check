...
SX127x library
How It Works
Sensor transmits standard LoRaWAN payload
Sniffer captures packet and appends parity byte
Bitflipper modifies payload to simulate attacks
Gateway script checks parity:
Valid → forwarded
Invalid → dropped
Subscriber decodes and logs received data
